...
from datasets import build_transform, EmotionDataset
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/lng5982/datasets/emotion_dataset', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19'],
                        type=str, help='Image Net dataset path')
    parser.add_argument('--inat-category', default='name',
                        choices=['angry', 'phylum', 'class', 'order', 'supercategory', 'family', 'genus', 'name'],
                        type=str, help='semantic granularity')
    parser.add_argument('--input_size', default=224,
                        type=int)

    parser.add_argument('--output_dir', default='./output/vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2',
    ...
    parser.add_argument('--distributed', action='store_true', default=True, help='Enabling distributed training')
...
def main(args):
    ...
    classes = os.listdir(args.data_path + "/train")
    ...
    dataset_train = EmotionDataset(args.data_path, classes = classes, is_train = True, transform = train_transform)
    dataset_val = EmotionDataset(args.data_path, classes = classes, is_train = False, transform = val_transform)
